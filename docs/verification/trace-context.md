...
## Shell-agnostic pane-carrier clear

Date: 2026-08-24.
Shell under test: fish 4.8.1 (Homebrew, macOS), the operator login shell a spawned pane inherits.
...
fish: 
unset TRACEPARENT; sh -c 'printf %s "$TRACEPARENT"'
^~~~^
