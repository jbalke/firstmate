...
A script with no hint gets the conservative `PORTABLE_SERIAL_DEFAULT_WEIGHT_MS` default; the current 158-script lane has twelve such scripts, bringing its assignment weight to 4638106 ms.
...
|---|---:|---:|
| `portable-serial-1of5` | 32 | 927624 ms (~15.46 min) |
| `portable-serial-2of5` | 32 | 927618 ms (~15.46 min) |
| `portable-serial-3of5` | 31 | 927619 ms (~15.46 min) |
| `portable-serial-4of5` | 31 | 927618 ms (~15.46 min) |
| `portable-serial-5of5` | 32 | 927627 ms (~15.46 min) |
| imbalance | | 9 ms |
